...
export default function DefaultDialog(props: DialogProps) {
  return (
    <Dialog {...props} className="relative z-10">
      <DialogBackdrop
        transition
        className="text-white fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in"
      />
